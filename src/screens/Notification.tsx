...
// import {
//   View, Text, StyleSheet, TouchableOpacity, Image, ScrollView, LayoutAnimation, Platform, UIManager,
//   FlatList,
//   ImageSourcePropType,
//   TextInput,
...
// //       subtitle: 'Đơn hàng #002 đã hoàn tất từ ngày 12/04',
// //       time: '12:42 - 12/04/2025',
// //       steps: [
// //         {
// //           title: 'Giao kiện hàng thành công',
// //           desc: 'Shipper đã giao hàng vào ngày 11/04.',
// //           time: '11:00 - 11/04/2025',
// //         },
// //         {
// //           title: 'Đang vận chuyển',
// //           desc: 'Đơn hàng đang được vận chuyển từ kho.',
// //           time: '09:00 - 10/04/2025',
// //         },
// //       ],
// //     },
// //     // More orders...
// //   ];
// // const image_temp = "../assets/images/products/1.jfif";
// const UpdateOrder = () => {
//     // const navigation: NavigationProp<RootStackParamList> = useNavigation();
// //   const [expanded, setExpanded] = useState(false);

//   const [updateOrders, setUpdateOrders] = useState<IUpdateOrder[]>([
//     { id: 1, name: "Đơn hàng đã hoàn tất",
//         description: "Đơn hàng DH002 đã hoàn thành. Bạn hãy đánh giá sản phẩm trước ngày 28-02-2025 để nhận được ưu đãi cho lần mua hàng tiếp theo và giúp người dùng khác hiểu hơn về sản phẩm nhé!",
//         image: require("../assets/images/products/1.png"),
//         created_at: '09:00 - 10/04/2025',
//     },
//     { id: 2, name: "Đơn hàng đã đang vận chuyển",
//         description: "Đơn hàng DH002 đã hoàn thành. Bạn hãy đánh giá sản phẩm trước ngày 28-02-2025 để nhận được ưu đãi cho lần mua hàng tiếp theo và giúp người dùng khác hiểu hơn về sản phẩm nhé!",
...
//     const addNew = (item: IUpdateOrder) => {
//         setUpdateOrders([...updateOrders, item])
//     }
...
//         <View>
//             <View>
//                 <Text  style={{fontSize: 30, paddingTop: 50,}}>Cập nhật đơn hàng:</Text>
//                 <Text>id đơn hàng</Text>
//                 <TextInput style = {{borderWidth: 1, borderColor: 'black', marginHorizontal: 20, }}/>
//                 <Text>trạng thái đơn hàng</Text>
//                 <TextInput style = {{borderWidth: 1, borderColor: 'black', marginHorizontal: 20, }}/>
//                 <Button title="Nhập vào" onPress={() => {}}/>
//             </View>
//                 {/* <Icon
//                     onPress={() => setModalVisible(true)}
//                     name="plus-square" size={40} color="orange" /> */}
//             <View>
//                 <FlatList
//                     data={updateOrders}
...
//                                     <Image source={item.image} style={{ width: 60, height: 60, borderRadius: 8, marginBottom: 10 }} />
//                                     <Text>{item.name}</Text>
